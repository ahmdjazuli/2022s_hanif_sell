          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h2 style="display:inline;">Pendapatan Bulanan</h2>
                  ...
                  <tbody>
                    <?php 
                      ...
                      while($data = mysqli_fetch_array($query)){
                        $bulan = $data['bulan'];
                        $tahun = $data['tahun'];
                        $woy = mysqli_fetch_array(mysqli_query($kon, "SELECT SUM(total) as total FROM beli INNER JOIN user ON beli.id = user.id WHERE MONTH(tglbeli) = '$bulan' AND YEAR(tglbeli) = '$tahun'"));
                        ...
                        ?>
                          ...
                          <td>Rp. <?= number_format($woy['total']-$woy2['total']-$woy3['total'],0,'.','.') ?></td>
                        <?php 
                      }
                    ?>
                  </tbody>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                ...
                <button style="float: right" class="btn btn-dark" type="button" data-toggle="modal" data-target="#harian" title="Cetak"><i class="fas fa-file-pdf"></i></button>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="dataTables" class="table table-bordered table-hover table-sm">
...
<div class="modal fade" id="harian">
        <div class="modal-dialog modal-default">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Filter Cetak</h4>
